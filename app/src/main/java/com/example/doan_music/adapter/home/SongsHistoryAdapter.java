...
public class SongsHistoryAdapter extends RecyclerView.Adapter<SongsHistoryAdapter.SongViewHolder> {

    private List<Song> songList;
    private Context context;
    private OnItemClickListener onItemClickListener;

    public SongsHistoryAdapter(Context context, List<Song> songList) {
    ...
    public SongViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_songs_history, parent, false);
