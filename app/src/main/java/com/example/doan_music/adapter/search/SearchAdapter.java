...
public class SearchAdapter extends RecyclerView.Adapter<com.example.doan_music.adapter.search.SearchAdapter.ViewHolder> implements Filterable {
    //khai báo biến
    Fragment context;
    ArrayList<ThuVien> arr, arr1;
    private OnItemClickListener onItemClickListener;

    public SearchAdapter(Fragment context, ArrayList<ThuVien> arr) {
